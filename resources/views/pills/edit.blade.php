<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Pills &raquo; {{$pill->name}} &raquo; Edit
        </h2>
    </x-slot>
    ...
    <div class="py-12 px-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            {{-- end bagian error --}}
            {{-- bagian form --}}
                <form action="{{route('pills.update', $pill->id)}}" class="w-full" method="POST">
                    @csrf
                    @method('PUT')
                        <div class="flex mb-3 space-x-4 px-4">
                            <div class="w-1/2">
                                <div class="text-sm">Name of Pills</div>
                                <div class="text-xl font-bold"> <input value="{{old('name') ?? $pill->name}}" name="name" class="apprearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 uppercase" id="grid-last-name" placeholder="Name of Pills" type="text"></div>
                            </div>

                            <div class="w-1/2">
                                <div class="text-sm">User</div>
                                <div class="text-xl font-bold"> <input value="{{old('username') ?? $pill->username}}" name="username" class="apprearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 uppercase" id="grid-last-name" placeholder="Name of Pills" type="text"></div>
                            </div>
                            ...
                            {{-- <div class="w-1/2">
                                ...
                                <select name="user_id" id="user_id" class="apprearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name">
                                    <option value="{{$pill->user_id}}">{{$pill->user->name}}</option>
                                    <option value="">===========================================================</option>
                        ...
                        <div class="flex mb-3 space-x-4 px-4">
                            <div class="w-1/2">
                                ...
                                <div class="text-xl font-bold">
                                    <input value="{{old('amount') ?? $pill->amount}}" name="amount" class="apprearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" placeholder="Amount" type="text">
                                </div>
                            </div>
                            <div class="w-1/2">
                                ...
                                <select name="type" id="type" class="apprearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name">
                                   <option value="{{$pill->type}}">{{$pill->type}}</option>
                                   <option value="">===========================================================</option>
                        ...
                        <div class="flex mb-3 space-x-4 px-4">
                            <div class="w-1/2">
                                ...
                                <select name="medicineForm" id="medicineForm" class="apprearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name">
                                    <option value="{{$pill->medicineForm}}">{{$pill->medicineForm}}</option>
                                    <option value="">=======================================</option>
                            ...
                            <div class="w-1/2">
                                ...
                                <div class="text-sm font-bold"> 
                                    <input value="{{old('schedule') ?? $pill->schedule}}" name="schedule" class="apprearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" placeholder="" type="datetime-local"/>
                                </div>
                            </div>
                            <div class="w-1/2">
                                ...
                                <select name="takeit" class="apprearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name">
                                    <option value="{{$pill->takeit}}">{{$pill->takeit == 1 ? "DONE" : "NOT YET"}}</option>
                                    <option value="">=====================================</option>
